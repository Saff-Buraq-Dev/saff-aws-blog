            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc green-color">
                        ...
                        <p>In this blog post, we'll explore how to configure a GitHub repository to assume an IAM role
                        ...
                        <p>By the end of this post, you'll understand how to create a secure and scalable deployment
                            pipeline that uses IAM OIDC identity providers, allowing you to control access from specific
                            branches and repositories. This approach not only enhances security but also simplifies the
                            management of credentials, making your AWS operations more robust and efficient.
                        </p>

                        <hr style="margin-bottom: 25px;">
                        <h4 style="margin-bottom: 25px;">Setting up the environment</h4>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <VCodeBlock :code="s3BucketCode" highlightjs lang="typescript" theme="atom-one-dark" />
                            </li>
                            <li>
                        ...
                        <ol>
                            ...
                            <li>
                                <p>Choose <strong>Add provider</strong> and choose <strong>OpenID Connect</strong> for
                        ...
                        <hr style="margin-bottom: 25px;">
                        <h4 style="margin-bottom: 25px;">Create an IAM role and scope the trust policy</h4>
                        <ol>
                            <li>Select <strong>the newly created IDP </strong>and click on <strong>Assign role</strong>.
                            </li>
                            <li>
                                <p>Create or choose an existing role.</p>
                                <p><Strong>Note:</Strong> The role must have enough permissions to create the resources
                                    you need.</p>
                            </li>
                            <li>
                        ...
                        <hr style="margin-bottom: 25px;">
                        <h4 style="margin-bottom: 25px;">Create a GitHub action to invoke the AWS CLI</h4>
                        ...
                        <ol>
                            ...
                            <li>
                                <p>Add a <strong>deploy.yml </strong> file in <strong>./github/workflows/</strong></p>
                            </li>
                            <li>
                                <p>Copy and paste then adapt the following code with your AWS_REGION...etc</p>
                                <VCodeBlock :code="githubActionsCode" highlightjs lang="yaml" theme="atom-one-dark" />
                            </li>
                            <li>
                        ...
                        <div class="post-footer">
                            <div class="post-tags">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/blog-tags/github-actions" rel="tag">github-actions</a></li>
                                    <li><a href="/blog-tags/integration" rel="tag">integration</a></li>
                                    <li><a href="/blog-tags/oidc" rel="tag">oidc</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
